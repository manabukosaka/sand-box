...
6. PR 作成は `.agents/scripts/codex-pr.sh` を使い、PR template の各セクションに Overview、ADR / Decision、Security Check、V&V Status、Screenshots / Logs、quality evidence を記載する。承認済み PR の merge は `.agents/scripts/codex-merge.sh` を使う。
